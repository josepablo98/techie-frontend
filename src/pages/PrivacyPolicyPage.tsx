...
const PrivacyPolicyPage = () => {
  ...
  const containerClasses =
    theme === "dark" ? "bg-gray-900 text-gray-100" : "bg-gray-100 text-black";
  ...
  return (
    // Usamos <main> para semántica y "min-h-screen" para asegurar altura mínima.
    <main className={`${containerClasses} min-h-screen flex flex-col`}>
      {/* El contenido se centra horizontalmente, pero empieza desde arriba.
          "overflow-y-auto" garantiza scroll si el texto es largo. */}
      <section className="flex-1 flex justify-center overflow-y-auto">
        {/* Espaciado superior e inferior para evitar que el card se pegue a los bordes */}
        <div className={`max-w-4xl w-full rounded-lg p-8 mt-8 mb-12 mx-4 ${cardClasses}`}>
